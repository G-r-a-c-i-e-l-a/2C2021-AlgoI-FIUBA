...
/*  
 *  Precondiciones: no tiene.
 *  Postcondiciones: imprime el banner y el saludo de los personajes.
 */
 ...
 */
void inicializar_obstaculos(nivel_t* nivel, objetos_t obstaculos[MAX_OBJETOS]) {
 ...
 */
void inicializar_herramientas(nivel_t* nivel, objetos_t herramientas[MAX_OBJETOS]) {
 ...
 */
void inicializar_niveles(nivel_t niveles[MAX_NIVELES], parametros_t parametros) {
    ...
    for (int i = 0; i < MAX_NIVELES; i++) {
        ...
        inicializar_obstaculos(&niveles[i], parametros.obstaculos);
        inicializar_herramientas(&niveles[i], parametros.herramientas);
    }
}
 ...
 */
void inicializar_juego(juego_t* juego, parametros_t parametros_iniciales) {

    juego->nivel_actual = NIVEL_UNO; 

    inicializar_niveles(juego->niveles, parametros_iniciales);
...
void jugar_partida(parametros_t parametros) {
    ...
    inicializar_juego(&juego, parametros);
