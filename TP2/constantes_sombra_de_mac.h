...
#define LETRA_VELA 'V'
#define ICONO_VELA "🕯️"      //están como literales porque no reconocia el código de Unicode
enum VELAS {VELAS_N1 = 5, VELAS_N2 = 10, VELAS_N3 = 12};  
#define FILAS_EFECTO_VELA 3
#define COLUMNAS_EFECTO_VELA 3  
#define LETRA_POZO 'W'
#define ICONO_POZO "🕳️"
enum POZOS {POZOS_N1 = 15, POZOS_N2 = 20, POZOS_N3 = 30};
#define LETRA_INTERRUPTOR 'O'
#define ICONO_INTERRUPTOR "🕹️"
enum ITERRUPTORES {INTERRUPTORES_N1 = 1, INTERRUPTORES_N2 = 2, INTERRUPTORES_N3 = 4};
#define LETRA_PORTAL 'P'
#define ICONO_PORTAL "🌀"
enum PORTALES {PORTALES_N1 = 0, PORTALES_N2 = 2, PORTALES_N3 = 4};


// Constantes relacionadas a las herramientas de los personajes
#define MAX_HERRAMIENTAS 4
#define LETRA_ESCALERA 'E'
#define ICONO_ESCALERA "🧗" 
enum ESCALERAS {ESCALERAS_N1 = 10, ESCALERAS_N2 = 15, ESCALERAS_N3 = 15}; 
#define LETRA_MONEDA 'C' 
#define ICONO_MONEDA "💰"
enum MONEDAS {MONEDAS_N1 = 10, MONEDAS_N2 = 15, MONEDAS_N3 = 15};
#define LETRA_LLAVE 'L'
#define ICONO_LLAVE "🗝️"
enum LLAVES {LLAVES_N1 = 0, LLAVES_N2 = 1, LLAVES_N3 = 1};
#define CANJE_PUNTOS_POR_VIDA 200
#define CANJE_PUNTOS_REVIVIR_BLUE 50
#define LETRA_PUERTA 'D'
#define ICONO_PUERTA "\U0001F6AA"
enum PUERTAS {PUERTAS_N1 = 1, PUERTAS_N2 = 1, PUERTAS_N3 = 1};
...
// Obstáculos y herramientas según nivel
typedef struct {
    char tipo;
